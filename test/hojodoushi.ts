...
tester.run('補助動詞', rule, {
  ...
  invalid: [
    ...
    //   errors: [
    //     {
    //       message: '平仮名にひらいたほうが読みやすい補助動詞を使用しています: 見な',
    //       range: [3, 4],
    //     },
    //   ],
    // },
...
tester.run(
  ...
  {
    valid: ['失礼を致さない', '失礼を致した', '失礼を致す', '失礼を致せ', '失礼を致そう'],
    invalid: [
      // {
      //   text: 'よろしくお願い致さない',
      //   output: 'よろしくお願いいたさない',
      //   errors: [
      //     {
      //       message: '平仮名にひらいたほうが読みやすい補助動詞を使用しています: 致さ',
      //       range: [7, 8],
      //     },
      //   ],
      // },
      ...
      //   errors: [
      //     {
      //       message: '平仮名にひらいたほうが読みやすい補助動詞を使用しています: 致す',
      //       range: [7, 8],
      //     },
      //   ],
      // },
      ...
      //   errors: [
      //     {
      //       message: '平仮名にひらいたほうが読みやすい補助動詞を使用しています: 致せ',
      //       range: [7, 8],
      //     },
      //   ],
      // },
      ...
      //   errors: [
      //     {
      //       message: '平仮名にひらいたほうが読みやすい補助動詞を使用しています: 致そ',
      //       range: [7, 8],
      //     },
      //   ],
      // },
